...
// Function that will trigger both of the functions described above and if both of them return true, send the form to the server.
function loginValidated(){
	...
	// Also, if the email does not match the regular expression stated in validateEmail(), show an alert with a message
...
// Function that will display the by-default hidden divs to upload the profile picture and assignments
